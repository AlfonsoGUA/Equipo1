...
class Mantenimiento_Estado:
    def __init__(self, parent_menu):
        ...
        self.window.title("Mantenimiento y estado de activos")
        ...
        self.etiqueta_titulo = tk.Label(frame, text = "Mantenimiento y estado de activos", font = self.fuente_titulo, bg = "white")
