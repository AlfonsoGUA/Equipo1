...
class Adicion_Edicion:
    def __init__(self, parent_menu):
        self.parent_menu = parent_menu
        self.window = tk.Toplevel(parent_menu)
        self.window.title("Adición y edición de activos")
        ...
        self.etiqueta_titulo = tk.Label(frame, text = "Adición y edición de activos", font = self.fuente_titulo, bg = "white")
